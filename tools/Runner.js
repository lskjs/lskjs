...
export default class Runner extends RunnerBase {
  async start2() {
    console.log('START');
  ...
  async start() {
    ...
    // await new Promise((resolve) => {
      ...
      console.log(333, config.output.publicPath);
      ...
      let handleBundleComplete = async () => {
        console.log('handleBundleComplete handleBundleComplete handleBundleComplete ');
      ...
      // setTimeout(handleBundleComplete, 15000);
 // bundler.hooks.beforeCompile.tapAsync("MyLoggingPlugin", (params, callback) => {
 //    console.log("starting");
 //    callback();
 //  });
 //   bundler.hooks.done.tap("MyLoggingPlugin", stats => {
 //    console.log("done");
 //  });
