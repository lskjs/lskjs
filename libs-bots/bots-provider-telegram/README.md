# LSK.js – bots-provider-telegram

> @lskjs/bots-provider-telegram – LSK.js plugin for @lskjs/bots module for telegram, slack, discord, whatsapp, twitter, instagram and vk bots creation

[![LSK logo](https://badgen.net/badge/icon/MADE%20BY%20LSK?icon=zeit\&label\&color=red\&labelColor=red)](https://github.com/lskjs)
[![NPM version](https://badgen.net/npm/v/@lskjs/bots-provider-telegram)](https://www.npmjs.com/package/@lskjs/bots-provider-telegram)
[![NPM downloads](https://badgen.net/npm/dt/@lskjs/bots-provider-telegram)](https://www.npmjs.com/package/@lskjs/bots-provider-telegram)
[![NPM Dependency count](https://badgen.net/bundlephobia/dependency-count/@lskjs/bots-provider-telegram)](https://bundlephobia.com/result?p=@lskjs/bots-provider-telegram)
[![Have TypeScript types](https://badgen.net/npm/types/@lskjs/bots-provider-telegram)](https://www.npmjs.com/package/@lskjs/bots-provider-telegram)
[![Have tree shaking](https://badgen.net/bundlephobia/tree-shaking/@lskjs/bots-provider-telegram)](https://bundlephobia.com/result?p=@lskjs/bots-provider-telegram)
[![NPM Package size](https://badgen.net/bundlephobia/minzip/@lskjs/bots-provider-telegram)](https://bundlephobia.com/result?p=@lskjs/bots-provider-telegram)
...
```sh
# yarn
yarn i @lskjs/bots-provider-telegram lodash

# npm
npm i @lskjs/bots-provider-telegram lodash
```
