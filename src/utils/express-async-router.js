...
const exp = {}
    ...
    function AsyncRouter(options) {
        ...
        asyncRouter.use = function use() {
            ...
            innerRouter.use.apply(innerRouter, args.map(function (arg) { return typeof arg === "function" && !arg.__asyncRouter ? wrapHandlerOrErrorHandler(arg) : arg; }));
            return this;
        };
        return asyncRouter;
    }
