...
[![NPM version](https://badgen.net/npm/v/@lskjs/env)](https://www.npmjs.com/package/@lskjs/env)
[![NPM downloads](https://badgen.net/npm/dt/@lskjs/env)](https://www.npmjs.com/package/@lskjs/env)
[![NPM Dependency count](https://badgen.net/bundlephobia/dependency-count/@lskjs/env)](https://bundlephobia.com/result?p=@lskjs/env)
[![Have TypeScript types](https://badgen.net/npm/types/@lskjs/env)](https://www.npmjs.com/package/@lskjs/env)
[![Have tree shaking](https://badgen.net/bundlephobia/tree-shaking/@lskjs/env)](https://bundlephobia.com/result?p=@lskjs/env)
[![NPM Package size](https://badgen.net/bundlephobia/minzip/@lskjs/env)](https://bundlephobia.com/result?p=@lskjs/env)
