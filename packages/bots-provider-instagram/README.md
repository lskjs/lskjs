# LSK.js – bots-provider-instagram

> @lskjs/bots-provider-instagram – LSK.js plugin for @lskjs/bots module for telegram, slack, discord, whatsapp, twitter, instagram and vk bots creation

[![LSK logo](https://badgen.net/badge/icon/MADE%20BY%20LSK?icon=zeit\&label\&color=red\&labelColor=red)](https://github.com/lskjs)
[![NPM version](https://badgen.net/npm/v/@lskjs/bots-provider-instagram)](https://www.npmjs.com/package/@lskjs/bots-provider-instagram)
[![NPM downloads](https://badgen.net/npm/dt/@lskjs/bots-provider-instagram)](https://www.npmjs.com/package/@lskjs/bots-provider-instagram)
[![NPM Dependency count](https://badgen.net/bundlephobia/dependency-count/@lskjs/bots-provider-instagram)](https://bundlephobia.com/result?p=@lskjs/bots-provider-instagram)
[![Have TypeScript types](https://badgen.net/npm/types/@lskjs/bots-provider-instagram)](https://www.npmjs.com/package/@lskjs/bots-provider-instagram)
[![Have tree shaking](https://badgen.net/bundlephobia/tree-shaking/@lskjs/bots-provider-instagram)](https://bundlephobia.com/result?p=@lskjs/bots-provider-instagram)
[![NPM Package size](https://badgen.net/bundlephobia/minzip/@lskjs/bots-provider-instagram)](https://bundlephobia.com/result?p=@lskjs/bots-provider-instagram)
...
```sh
# yarn
yarn i @lskjs/bots-provider-instagram lodash

# npm
npm i @lskjs/bots-provider-instagram lodash
```
