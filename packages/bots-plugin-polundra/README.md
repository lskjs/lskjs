# LSK.js – bots-plugin-polundra

> @lskjs/bots-plugin-polundra – LSK.js plugin for @lskjs/bots module for telegram, slack, discord, whatsapp, twitter, instagram and vk bots creation

[![LSK logo](https://badgen.net/badge/icon/MADE%20BY%20LSK?icon=zeit\&label\&color=red\&labelColor=red)](https://github.com/lskjs)
[![NPM version](https://badgen.net/npm/v/@lskjs/bots-plugin-polundra)](https://www.npmjs.com/package/@lskjs/bots-plugin-polundra)
[![NPM downloads](https://badgen.net/npm/dt/@lskjs/bots-plugin-polundra)](https://www.npmjs.com/package/@lskjs/bots-plugin-polundra)
[![NPM Dependency count](https://badgen.net/bundlephobia/dependency-count/@lskjs/bots-plugin-polundra)](https://bundlephobia.com/result?p=@lskjs/bots-plugin-polundra)
[![Have TypeScript types](https://badgen.net/npm/types/@lskjs/bots-plugin-polundra)](https://www.npmjs.com/package/@lskjs/bots-plugin-polundra)
[![Have tree shaking](https://badgen.net/bundlephobia/tree-shaking/@lskjs/bots-plugin-polundra)](https://bundlephobia.com/result?p=@lskjs/bots-plugin-polundra)
[![NPM Package size](https://badgen.net/bundlephobia/minzip/@lskjs/bots-plugin-polundra)](https://bundlephobia.com/result?p=@lskjs/bots-plugin-polundra)
...
```sh
# yarn
yarn i @lskjs/bots-plugin-polundra lodash

# npm
npm i @lskjs/bots-plugin-polundra lodash
```
