# LSK.js – bots-plugin-download

> @lskjs/bots-plugin-download – LSK.js plugin for @lskjs/bots module for telegram, slack, discord, whatsapp, twitter, instagram and vk bots creation
