# LSK.js – bots-provider-discord

> @lskjs/bots-provider-discord – LSK.js plugin for @lskjs/bots module for telegram, slack, discord, whatsapp, twitter, instagram and vk bots creation

[![LSK logo](https://badgen.net/badge/icon/MADE%20BY%20LSK?icon=zeit\&label\&color=red\&labelColor=red)](https://github.com/lskjs)
[![NPM version](https://badgen.net/npm/v/@lskjs/bots-provider-discord)](https://www.npmjs.com/package/@lskjs/bots-provider-discord)
[![NPM downloads](https://badgen.net/npm/dt/@lskjs/bots-provider-discord)](https://www.npmjs.com/package/@lskjs/bots-provider-discord)
[![NPM Dependency count](https://badgen.net/bundlephobia/dependency-count/@lskjs/bots-provider-discord)](https://bundlephobia.com/result?p=@lskjs/bots-provider-discord)
[![Have TypeScript types](https://badgen.net/npm/types/@lskjs/bots-provider-discord)](https://www.npmjs.com/package/@lskjs/bots-provider-discord)
[![Have tree shaking](https://badgen.net/bundlephobia/tree-shaking/@lskjs/bots-provider-discord)](https://bundlephobia.com/result?p=@lskjs/bots-provider-discord)
[![NPM Package size](https://badgen.net/bundlephobia/minzip/@lskjs/bots-provider-discord)](https://bundlephobia.com/result?p=@lskjs/bots-provider-discord)
...
```sh
# yarn
yarn i @lskjs/bots-provider-discord lodash

# npm
npm i @lskjs/bots-provider-discord lodash
```
