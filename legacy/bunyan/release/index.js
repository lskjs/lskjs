...
function resolveLevel(nameOrNum) {
  var level;
  var type = (0, _typeof2["default"])(nameOrNum);
...
function Logger(options, _childOptions, _childSimple) {
  ...
  if (options.serializers && ((0, _typeof2["default"])(options.serializers) !== 'object' || Array.isArray(options.serializers))) {
...
function mkRecord(log, minLevel, args) {
  ...
  } else if ((0, _typeof2["default"])(args[0]) !== 'object' || Array.isArray(args[0])) {
    // `log.<level>(msg, ...)`
    fields = null;
    msgArgs = args.slice();
...
if (mv) {
  RotatingFileStream = function RotatingFileStream(options) {
    ...
    assert.equal((0, _typeof2["default"])(this.count), 'number', format('rotating-file stream "count" is not a number: %j (%s) in %j', this.count, (0, _typeof2["default"])(this.count), this));
...
module.exports.nameFromLevel = nameFromLevel; // module.exports.VERSION = require('../package.json').version;
